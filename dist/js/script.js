...

{
  ...
  class CartProduct {
    constructor(menuProduct, element) {
      ...
      // Ensure that the passed 'element' parameter is a valid DOM element
      if (element instanceof HTMLElement) {
        thisCartProduct.element = element;
      } else {
        throw new Error("Invalid 'element' parameter in CartProduct constructor.");
      }
    ...
    getElements() {
      ...
      thisCartProduct.dom = {};
      thisCartProduct.dom.amountWidget = thisCartProduct.element.querySelector(
        select.cartProduct.amountWidget
      );
      thisCartProduct.dom.price = thisCartProduct.element.querySelector(
        select.cartProduct.price
      );
      thisCartProduct.dom.edit = thisCartProduct.element.querySelector(
    ...
    initAmountWidget() {
      ...
      if (thisCartProduct.dom.amountWidget) {
        ...
        // Update the cart product when the amount widget is updated
        thisCartProduct.amountWidget.element.addEventListener("updated", () => {
          thisCartProduct.amount = thisCartProduct.amountWidget.value;
          const totalProductPrice = thisCartProduct.priceSingle * thisCartProduct.amount;
          thisCartProduct.dom.price.innerHTML = totalProductPrice; // Update the displayed price
          thisCartProduct.price = totalProductPrice; // Update the cart product's price property
        });
      }
    }
  }
